...
import com.xinyuan.model.HumanResource.EmployeeDormOrder;
...
public class ConfigFormat {
	...
	static {
		...
		orderNOPrefixMap.put(EmployeeDormOrder.class.getName(), 	"SSD");
		...
		orderNOPrefixMap.put(WHScrapOrder.class.getName(),              "BFD");
		orderNOPrefixMap.put(WHInventoryOrder.class.getName(),         "CKKC");
