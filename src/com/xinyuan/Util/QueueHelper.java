...
public class QueueHelper {
	...
	public static List<Object> getRefreshDataList() {
		...
		String appSettingTableString = IntrospectHelper
				.getShortClassName(APPSettings.class);
		List<Object> settingList = dao
				.getObjects("select settings.settings from "
						+ appSettingTableString
						+ " settings where settings.type = '"
						+ ConfigConstants.APPSettings_TYPE_ADMIN_APPROVALS
						+ "'");
