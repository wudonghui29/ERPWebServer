...
public class HumanResourceDAOIMP extends ModelDAOIMP implements HumanResourceDAO {
	...
	public List<Object> getUsersNOPairs() {
		String hqlString = "select employee.employeeNO , employee.name, employee.jobLevel, employee.inVisits, employee.department, employee.subDepartment from Employee as employee ";
